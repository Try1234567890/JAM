...
public abstract class LimitedStreamReaderAsStringArray extends LimitedStreamReader<String[]> {

    protected LimitedStreamReaderAsStringArray(InputStream input) {
        super(input);
    }
    ...
    public static class StreamReaderAsStringArrayConfiguration extends StreamReaderConfiguration<String[]> {
